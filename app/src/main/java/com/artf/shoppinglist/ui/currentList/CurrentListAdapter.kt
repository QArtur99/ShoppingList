...
import com.artf.shoppinglist.databinding.ItemShoppingListBinding
...
class CurrentListAdapter(
    ...
    class MsgViewHolder constructor(private val binding: ItemShoppingListBinding) :
    ...
    interface ClickListenerInt {
        fun onClickListenerRow(productId: ShoppingList)
        fun onClickListenerButton(productId: ShoppingList)
    }
}